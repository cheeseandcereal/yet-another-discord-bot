...
async def send_simple_message(message, trigger_type: str, trigger: str):
    """
...
async def linux_saying(message, trigger_type: str, trigger: str):
    """
