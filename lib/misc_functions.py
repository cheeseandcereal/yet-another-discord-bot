...
async def add_random_reaction(client, message):
    ...
    :param message: Relevant discord message
    :returns: Nothing
    """
...
async def send_simple_message(client, message, trigger_type, trigger):
    """
    Send a simple message response
    :param client: Discord client
    :param message: Relevant discord message
    :param trigger_type: The trigger type for this message
    :param trigger: The string that caused this trigger
    :returns: Nothing
    """
...
async def linux_saying(client, message, trigger_type, trigger):
    """
...
async def handle_choose(client, message, trigger_type, trigger):
    """
